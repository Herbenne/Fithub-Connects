...
<body>
    <div class="dashboard-container">
        ...
        <nav>
            <a href="superadmin_dashboard.php"><i class="fa-solid fa-table-columns"></i>Superadmin Dashboard</a>
            <a href="manage_users.php"><i class="fa-solid fa-user"></i>Manage Users</a>
            <!-- <a href="manage_membership_plans.php"><i class="fa-solid fa-people-roof"></i>Membership Plans</a>
            <a href="attendance_logs.php"><i class="fa-solid fa-clipboard-user"></i>Attendance Logs</a> -->
            <a href="admin_login_form.php"><i class="fa-solid fa-right-from-bracket"></i>Logout</a>
        </nav>
